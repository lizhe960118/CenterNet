...
class FCOS_PLUS_Head(nn.Module):
    ...
    def __init__(self,
                 ...
                 loss_cls=dict(
                     ...
                     loss_weight=1.0),
                     # add linear IOULoss
                 loss_bbox=dict(type='LinearIoULoss', loss_weight=1.0), 
        ...
        super(FCOS_PLUS_Head, self).__init__()
    ...
    def get_sample_region(self, gt, strides, num_points_per, gt_xs, gt_ys, radius=1):
        num_gts = gt.shape[1] # [num_points, num_gts, 4]
        K = len(gt_xs)
